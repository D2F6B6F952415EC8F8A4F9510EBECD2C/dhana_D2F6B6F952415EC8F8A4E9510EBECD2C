...
attributes for account number, account holder, and account balance.Include methods to
deposit money, withdraw money, and display the account balance. Ensure that the account balance
Cannot be accessed directly from outside the class. Write a program to create an intance of the 
  ...
  def withdraw(self, amount):
    if amount > 0 and amount <= self.__account_balance:
      ...
      print("withdrew ₹{}. New balance: ₹{}".format(amount,  
        ...
        print("Invaild withdrawel amount or insufficient balance.")
...
# test deposit and withdrawel functionaitiy
